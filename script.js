...
const firebaseConfig = typeof __firebase_config !== 'undefined' 
    ...
    : {}; // Fallback to an empty object to avoid errors

const appId = typeof __app_id !== 'undefined' ? __app_id : 'default-pos-app';


// Check if the Firebase configuration is valid before running the app
if (!firebaseConfig.apiKey || firebaseConfig.apiKey === "YOUR_API_KEY") {
    console.error("Firebase configuration is missing or invalid.");
    // Display a user-friendly error on the page
    document.body.innerHTML = `<div style="font-family: Manrope, sans-serif; color: #a5b6a0; text-align: center; padding: 50px; background-color: #131712; height: 100vh; display: flex; flex-direction: column; justify-content: center; align-items: center;">
                                    <h1 style="color: white; font-size: 28px; font-weight: bold;">Configuration Error</h1>
                                    <p style="font-size: 16px;">The application cannot start because it is missing a valid Firebase configuration. Please ensure the app is running in the correct environment.</p>
                               </div>`;
} else {
    // Initialize Firebase since the config is valid
